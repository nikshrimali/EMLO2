...
const CONFIG = {
  "backend_url": "https://sy7ptfj5me.execute-api.ap-south-1.amazonaws.com/dev/inference"
}
    ...
    <div className="flex min-h-screen flex-col items-center justify-center py-2">
      <main className="flex w-full flex-1 flex-col items-center justify-center px-20 text-center">
        ...
        <div className="mt-10 text-lg">
          Select a PNG Image from <a href="https://github.com/atulgupta01/EMLO/tree/main/Assignment08/lightning-hydra-template/Images" target="_blank" className='text-blue-600'>Example</a>
        </div>
